  ...
  return (
    <div className="fixed inset-0">
      ...
      <div className="absolute bottom-3 right-3 flex items-center gap-2">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 rounded-full bg-black/80 border border-line px-3 py-1.5 text-xs text-white/90 hover:text-white backdrop-blur transition-colors"
        >

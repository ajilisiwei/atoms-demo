...
export const shellDict: Record<string, { en: string; zh: string }> = {
  ...
  "shell.favorites": { en: "Favorites", zh: "已收藏" },
  "shell.moreActions": { en: "More actions", zh: "更多操作" },
  "shell.favorite": { en: "Add to favorites", zh: "收藏" },
  "shell.unfavorite": { en: "Remove from favorites", zh: "取消收藏" },
  "shell.rename": { en: "Rename", zh: "重命名" },
  "shell.renameTitle": { en: "Rename app", zh: "重命名应用" },
  "shell.save": { en: "Save", zh: "保存" },
  "shell.actionFailed": { en: "Action failed — please retry", zh: "操作失败，请重试" },
  "shell.tabAll": { en: "All", zh: "全部" },
  "shell.tabFavorites": { en: "Favorites", zh: "已收藏" },
